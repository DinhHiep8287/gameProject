...
class Tile {
public:
    Tile(int mapX, int mapY, int id, int numTilesetX, int numTilesetY, int width = TILE_SIZE, int height = TILE_SIZE);
...
Tile::Tile(int mapX, int mapY, int id, int numTilesetX, int numTilesetY, int width, int height)
